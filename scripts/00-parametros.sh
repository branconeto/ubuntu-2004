...
# 10. /var/lib/bind/sbn.local.hosts = arquivo de configuração da Zona de Pesquisa Direta
...
# 02. less /var/lib/bind/sbn.local.hosts = arquivo de configuração da Zona de Pesquisa Direta
